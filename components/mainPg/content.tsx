  ...
  return (
    <div className=" mt-12 px-5">
      ...
      <div className="flex flex-col">
        <span className=" text-lg font-bold">1박 2일 썸타임즈 &gt;</span>
      ...
      <div className="mt-5">
        ...
        <div>
          ...
          <span className="text-xs">(20/30) 10월 5일, 6일 금정구 힐링 테마농장</span>
        </div>
        {/* image */}
        <div>
          <Image src={ContentImage1} alt="" objectFit="cover" className="w-full rounded-lg my-2" />
          <span className="text-xs">(40) 10월 12일,13일 금정구 힐링 테마농장</span>
        </div>
      </div>
    </div>
  );
