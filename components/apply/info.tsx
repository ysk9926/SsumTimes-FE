  ...
  return (
    <div className=" w-[900px] mb-20">
      ...
      <div className="flex flex-col font-semibold text-sm space-y-1 mb-5">
        ...
        <span>- 수정/변경: 이미 제출한 내용을 수정/변경하시려면 다시 제출해주시면 됩니다. (가장 최근에 제출하신 신청서만 활용됩니다.)</span>
      </div>
      {/* 경고 */}
      <span className=" font-semibold text-sm text-red-500">※ 하트트래블 각 회차별 참가 신청은 '하트트래블 신청하기' 메뉴에서 별도로 해주셔야 합니다.</span>
    </div>
  );
}
